    ...
    <form onSubmit={handleSubmit} className="space-y-5" noValidate>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            className="w-full h-10 px-3 rounded-md border border-[#2a2a2a] bg-background text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-0 focus:border-[#F5A623] transition-shadow"
          />
        </div>
        <div>
          <label
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          ...
          <select
            ...
            onChange={handleChange}
            className="w-full h-10 px-3 rounded-md border border-[#2a2a2a] bg-background text-sm text-foreground focus:outline-none focus:ring-0 focus:border-[#F5A623] transition-shadow appearance-none cursor-pointer"
          >
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full px-3 py-2.5 rounded-md border border-[#2a2a2a] bg-background text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-0 focus:border-[#F5A623] transition-shadow resize-none"
        />
      </div>
